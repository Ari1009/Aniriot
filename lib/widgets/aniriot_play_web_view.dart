...
/// [AniriotPlayWebView] is a webview specifically tailored for the needs of the
...
/// hassle.
class AniriotPlayWebView extends StatefulWidget {
  const AniriotPlayWebView({
  ...
  @override
  State<AniriotPlayWebView> createState() => _AniriotPlayWebViewState();
}

class _AniriotPlayWebViewState extends State<AniriotPlayWebView> {
